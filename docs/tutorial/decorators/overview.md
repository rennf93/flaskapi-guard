...
title: Security Decorators Overview - FlaskAPI Guard
description: Learn how to use FlaskAPI Guard's security decorators for route-level protection and fine-grained security controls
keywords: security decorators, route protection, flask security, extension decorators
---

Security Decorators Overview
=============================

FlaskAPI Guard's security decorators allow you to apply fine-grained security controls to individual routes, complementing the global extension protection. This gives you the flexibility to customize security policies on a per-endpoint basis.
...
Security decorators are Python decorators that you can apply to your Flask route functions to add specific security measures. They work alongside the global FlaskAPIGuard to provide layered protection.
...
- **Override Global Settings**: Route decorators can override global extension settings
...
app.extensions["guard_decorator"] = guard_deco
```
...
2. Global Extension Settings - Application-wide defaults
...
Decorators integrate with extension error handling:

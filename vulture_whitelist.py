# noqa
"""
Vulture whitelist for Flask API Guard.
...
# Flask specific - these are used by Flask's routing
# and may appear unused to static analysis
app  # type: ignore  # pragma: no cover
before_request  # type: ignore  # pragma: no cover
after_request  # type: ignore  # pragma: no cover
route  # type: ignore  # pragma: no cover
...
__enter__  # type: ignore  # pragma: no cover
__exit__  # type: ignore  # pragma: no cover
...
# Security headers and extension specific
...
# Flask API Guard specific patterns

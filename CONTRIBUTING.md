Contributing to FlaskAPI Guard
=============================

Thank you for considering contributing to FlaskAPI Guard! This document outlines the process for contributing to this Python library and helps ensure a smooth collaboration experience.
...
- Specify your environment: OS, Python version, Flask version, etc.
...
- Explain why this enhancement would be useful to FlaskAPI Guard users
...
The documentation for FlaskAPI Guard is built with MkDocs. To build and view the documentation locally:
...
Thank you for contributing to FlaskAPI Guard!

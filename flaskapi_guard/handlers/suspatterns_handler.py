...
class SusPatternsManager:
    ...
    def __new__(
        ...
        if cls._instance is None:
            ...
            cls._instance.compiled_patterns = [
                (re.compile(p, re.IGNORECASE | re.MULTILINE), ctx)
                for p, ctx in cls._pattern_definitions
            ]
    ...
    def _send_pattern_event(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logging.getLogger("flaskapi_guard.handlers.suspatterns").error(
    ...
    def _check_regex_pattern(
        ...
        if self._compiler:
            ...
            if match is None and time.time() - pattern_start >= 0.9 * 2.0:
                ...
                logging.getLogger("flaskapi_guard.handlers.suspatterns").warning(
    ...
    def _check_pattern_with_timeout(
        ...
        with executor_class(max_workers=1) as executor:
            ...
            try:
                ...
                logger = logging.getLogger("flaskapi_guard.handlers.suspatterns")
                logger.warning(
    ...
    def detect(
        ...
        regex_threats, matched_patterns, timeouts = self._check_regex_patterns(
            processed_content, ip_address, correlation_id, context=context
        )
    ...
    def add_pattern(cls, pattern: str, custom: bool = False) -> None:
        ...
        if custom:
            instance.compiled_custom_patterns.add((compiled_pattern, _CTX_ALL))
            ...
            instance.compiled_patterns.append((compiled_pattern, _CTX_ALL))

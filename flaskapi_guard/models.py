...
class SecurityConfig(BaseModel):
    ...
    custom_request_check: Callable[[Request], Response | None] | None = Field(
        default=None, description="Perform additional checks on the request"
    )
    """
    Callable[
        [Request],
    ...
    custom_response_modifier: Callable[[Response], Response] | None = Field(
        default=None,

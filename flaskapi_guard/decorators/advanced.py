...
from flaskapi_guard.decorators.base import BaseSecurityMixin
...
class AdvancedMixin(BaseSecurityMixin):
    ...
    def honeypot_detection(
        ...
        def decorator(func: Callable[..., Any]) -> Callable[..., Any]:
            def honeypot_validator(request: Request) -> Response | None:
                ...
                def _validate_form_data() -> Response | None:
                ...
                def _validate_json_data() -> Response | None:

# Security Policy for FlaskAPI Guard

## Supported Versions

We currently provide security updates for the following versions of FlaskAPI Guard:
...
We take the security of FlaskAPI Guard seriously. If you believe you've found a security vulnerability, please follow these steps:

1. **Do not disclose the vulnerability publicly** until it has been addressed by the maintainers.
2. **Report the vulnerability through GitHub's security advisory feature**:
   - Go to the [Security tab](https://github.com/rennf93/flaskapi-guard/security/advisories) of the FlaskAPI Guard repository
   - Click on "New draft security advisory"
   - Fill in the details of the vulnerability
   - Submit the advisory

   Alternatively, you can report vulnerabilities through [GitHub's private vulnerability reporting feature](https://github.com/rennf93/flaskapi-guard/security/advisories/new).
...
When using FlaskAPI Guard in your applications, consider the following security best practices:
...
3. **Alerts**: Set up alerts for unusual patterns detected by FlaskAPI Guard

### Dependency Management

1. Regularly update FlaskAPI Guard and its dependencies to the latest versions
2. Use a dependency scanning tool to identify and address vulnerabilities in your dependency tree

## Security Features

FlaskAPI Guard provides several security features to protect your Flask applications:
...
For detailed information on configuring these features, refer to the [documentation](https://rennf93.github.io/flaskapi-guard).

## Threat Model

FlaskAPI Guard is designed to protect against common web application threats, including:
...
Note that FlaskAPI Guard is a defense-in-depth measure and should be used alongside other security controls such as proper authentication, authorization, input validation, and output encoding.
...
FlaskAPI Guard is licensed under the MIT License. See the [LICENSE](LICENSE) file for details.
